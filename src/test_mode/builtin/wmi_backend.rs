...
impl Backend {
  ...
  pub fn start() -> e_utils::AnyResult<Backend> {
    ...
    {
      return Self::start_one(crate::aida64::AIDA64::EXE, crate::aida64::AIDA64::DIR, || {
        Ok(Backend::Aida64(crate::aida64::AIDA64::new()?))
      });
    }
  ...
  fn start_one(exe: &'static str, dir: &'static str, connect: impl FnOnce() -> e_utils::AnyResult<Backend>) -> e_utils::AnyResult<Backend> {
